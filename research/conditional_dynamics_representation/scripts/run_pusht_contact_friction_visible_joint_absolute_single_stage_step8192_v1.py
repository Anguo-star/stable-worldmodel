#!/usr/bin/env python3
"""Final discovery-budget extension of the simple Contact joint candidate.

The 4,096-step endpoint was still improving and produced a same-checkpoint
ICL/CEM Pareto point.  This arm doubles only the optimizer-step budget from the
same published initialization.  It adds no loss, parameter, module, data,
teacher, or inference operation.
"""
...
CANDIDATE = (
    "pusht_contact_friction_visible_joint_absolute_single_stage_step8192_v1"
)
OPTIMIZER_STEPS = 8192
PARENT_SIDECAR = "contact_visible_joint_absolute_single_stage_method_v1.json"
SIDECAR = (
    "contact_visible_joint_absolute_single_stage_step8192_method_v1.json"
)
    ...
    contract.update(
        {
            ...
            "one_factor_change": "optimizer steps 2048 -> 8192",
            "budget_extension_only": True,
            "discovery_budget_extension_final": True,
        }
    )
